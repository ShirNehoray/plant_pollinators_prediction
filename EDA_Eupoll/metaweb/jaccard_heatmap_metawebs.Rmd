...
# --- Step 3: Filter only Apidae pollinators ---
data_apidae <- data %>%
  filter(Pollinator_family == "Apidae")

# --- Step 4: Define bioregions and initialize a list ---
bioregions <- c("Alpine", "Atlantic", "Boreal", "Continental")
metaweb_list <- list()

# --- Step 5: Loop through each bioregion to create metawebs (Apidae only) ---
...
# --- Step 6: Prepare a list of unique interaction pairs for each bioregion ---
...
# --- Step 7: Calculate pairwise Jaccard similarities (binary) ---
...
# --- Step 8: Convert Jaccard matrix for plotting ---
...
ggplot(jaccard_df, aes(x = Bioregion1, y = Bioregion2, fill = Jaccard)) +
  ...
  theme_minimal() +
  labs(title = "Jaccard Similarity of Plant-Apidae Metawebs",
       x = "Bioregion", y = "Bioregion") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        plot.title = element_text(hjust = 0.5))

# --- Step 10: Calculate pairwise Bray–Curtis similarities (quantitative) ---
...
ggplot(bray_df, aes(x = Bioregion1, y = Bioregion2, fill = BrayCurtis)) +
  ...
  theme_minimal() +
  labs(title = "Bray–Curtis Similarity of Plant-Apidae Metawebs (Quantitative)",
       x = "Bioregion", y = "Bioregion") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        plot.title = element_text(hjust = 0.5))
